...
![version](https://img.shields.io/badge/version-v3.0-blue) ![platform](https://img.shields.io/badge/platform-Windows-lightgrey) ![python](https://img.shields.io/badge/python-3.10%2B-green)
...
1. 到本仓库 **[Releases](../../releases)** 下载 `QwenDesktopAgent_v3.0.zip` 并解压。
...
然后每次发布新版时，在 GitHub Releases 里创建新版本，并上传 `QwenDesktopAgent_v3.0.zip` 这类 zip 更新包。程序会自动读取 Release 的版本号、更新说明和 zip 下载地址。
...
{
  "version": "v3.0",
  "package_url": "https://example.com/QwenDesktopAgent_v3.0.zip",
  "package_name": "QwenDesktopAgent_v3.0.zip",
...
产物在 `QwenDesktopAgent_v3.0/`，主程序 `QwenDesktopAgent.exe`。脚本会：
...
发布到 GitHub：源码进仓库，**把 `QwenDesktopAgent_v3.0` 压成 zip 上传到 [Releases](../../releases)**，不要把成品/模型塞进代码树。
